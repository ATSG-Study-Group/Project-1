...
SET Script=C:\Users\dave\Development\WorkProjects\ATSG StudyGroup\Project-1\Scripts\SendDLL.ps1
...
POWERSHELL -NoProfile -ExecutionPolicy Bypass -File "%Script%" "%FileName%" -DevFolder "%CallingFolder%" -programSlot %Slot%
pause